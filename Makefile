...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sat Dec 10 10:45:30 2011
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/collision-detect1.0.0/ && $(COPY_FILE) --parents src/globals.h src/control/Controller.h src/control/HeadwayKalmanFilter.h src/control/ReactionTimeTracker.h src/devices/AndroidDevice.h src/devices/ArduinoDevice.h src/devices/OBDDevice.h src/gui/GUIController.h src/gui/HeadwayTab.h src/gui/InspectorWindow.h src/gui/SensorsTab.h src/gui/VideoWindow.h src/sensors/DistanceSensor.h src/sensors/HumiditySensor.h src/sensors/RainSensor.h src/sensors/SpeedSensor.h src/sensors/TemperatureSensor.h src/util/MatToQImage.h src/vision/Capture.h src/vision/LaneDetector.h src/vision/VehicleDetector.h obj/collision-detect1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/control/Controller.cpp src/control/HeadwayKalmanFilter.cpp src/control/ReactionTimeTracker.cpp src/devices/AndroidDevice.cpp src/devices/ArduinoDevice.cpp src/devices/OBDDevice.cpp src/gui/GUIController.cpp src/gui/HeadwayTab.cpp src/gui/InspectorWindow.cpp src/gui/SensorsTab.cpp src/gui/VideoWindow.cpp src/sensors/DistanceSensor.cpp src/sensors/HumiditySensor.cpp src/sensors/RainSensor.cpp src/sensors/SpeedSensor.cpp src/sensors/TemperatureSensor.cpp src/util/MatToQImage.cpp src/vision/Capture.cpp src/vision/LaneDetector.cpp src/vision/VehicleDetector.cpp obj/collision-detect1.0.0/ && (cd `dirname obj/collision-detect1.0.0` && $(TAR) collision-detect1.0.0.tar collision-detect1.0.0 && $(COMPRESS) collision-detect1.0.0.tar) && $(MOVE) `dirname obj/collision-detect1.0.0`/collision-detect1.0.0.tar.gz . && $(DEL_FILE) -r obj/collision-detect1.0.0
...
compiler_moc_header_make_all: moc/moc_Controller.cpp moc/moc_HeadwayKalmanFilter.cpp moc/moc_ReactionTimeTracker.cpp moc/moc_AndroidDevice.cpp moc/moc_GUIController.cpp moc/moc_HeadwayTab.cpp moc/moc_InspectorWindow.cpp moc/moc_SensorsTab.cpp moc/moc_VideoWindow.cpp moc/moc_DistanceSensor.cpp moc/moc_HumiditySensor.cpp moc/moc_RainSensor.cpp moc/moc_SpeedSensor.cpp moc/moc_TemperatureSensor.cpp moc/moc_Capture.cpp moc/moc_LaneDetector.cpp moc/moc_VehicleDetector.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc/moc_Controller.cpp moc/moc_HeadwayKalmanFilter.cpp moc/moc_ReactionTimeTracker.cpp moc/moc_AndroidDevice.cpp moc/moc_GUIController.cpp moc/moc_HeadwayTab.cpp moc/moc_InspectorWindow.cpp moc/moc_SensorsTab.cpp moc/moc_VideoWindow.cpp moc/moc_DistanceSensor.cpp moc/moc_HumiditySensor.cpp moc/moc_RainSensor.cpp moc/moc_SpeedSensor.cpp moc/moc_TemperatureSensor.cpp moc/moc_Capture.cpp moc/moc_LaneDetector.cpp moc/moc_VehicleDetector.cpp
...
moc/moc_Capture.cpp: src/vision/Capture.h
	/opt/QtSDK/Desktop/Qt/474/gcc/bin/moc $(DEFINES) $(INCPATH) src/vision/Capture.h -o moc/moc_Capture.cpp
...
obj/Capture.o: src/vision/Capture.cpp src/vision/Capture.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/Capture.o src/vision/Capture.cpp
...
obj/moc_Capture.o: moc/moc_Capture.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/moc_Capture.o moc/moc_Capture.cpp
